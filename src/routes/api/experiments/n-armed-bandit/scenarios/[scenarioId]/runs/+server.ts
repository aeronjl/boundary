...
import { banditExperimentSlug, getBanditPolicyScenario } from '$lib/experiments/bandit';
...
import { runBanditPolicyScenario } from '$lib/server/experiments/policy-scenarios';
import {
...
export const POST: RequestHandler = async ({ cookies, params, request }) => {
	...
	try {
		...
		const update = await runBanditPolicyScenario(scenario, {
